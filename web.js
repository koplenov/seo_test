...
;
	($.$mol_icon_favorite) = class $mol_icon_favorite extends ($.$mol_icon) {
		path(){
...
;
	($.$hyoo_scout_suggest) = class $hyoo_scout_suggest extends ($.$mol_page) {
		close_icon(){
			const obj = new this.$.$mol_icon_close();
			return obj;
		}
		...
		Reason(){
			...
			(obj.value) = (next) => ((this.reason(next)));
			(obj.options) = () => ({
				"Внимание": "Внимание", 
		...
		Stuff(){
			...
			(obj.value) = (next) => ((this.stuff(next)));
			return obj;
		}
		Stuff_field(){
			const obj = new this.$.$mol_form_field();
	...
	($mol_mem(($.$hyoo_scout_suggest.prototype), "close_icon"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Close"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "name"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Name"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Name_field"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "icon"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Icon"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Icon_field"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "descr"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Descr"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Descr_field"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "reason"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Reason"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Reason_field"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "age"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Age"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Age_field"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "place"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Place"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Place_field"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "stuff"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Stuff"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Stuff_field"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "prep"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Prep"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Prep_field"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "duration"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Duration"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Duration_field"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "submit"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Submit"));
	($mol_mem(($.$hyoo_scout_suggest.prototype), "Form"));
...
var $;
(function ($) {
    $mol_style_attach("hyoo/scout/suggest/suggest.view.css", "[hyoo_scout_suggest] {\n\tflex: 1000 0 30rem;\n}\n\n[hyoo_scout_suggest_form] [mol_switch] {\n\tbackground: var(--mol_theme_field);\n}\n\n[hyoo_scout_suggest_duration_option] ,\n[hyoo_scout_suggest_prep_option] {\n\tflex: 1 1 6rem;\n}\n\n[hyoo_scout_suggest_age_option] ,\n[hyoo_scout_suggest_place_option] {\n\tflex: 1 1 8rem;\n}\n\n[hyoo_scout_suggest_reason_option] {\n\tflex: 1 1 10rem;\n}\n");
})($ || ($ = {}));
...
;
	($.$hyoo_scout) = class $hyoo_scout extends ($.$mol_book2) {
		Theme(){
		...
		Filter(){
			...
			(obj.body) = () => ([(this.Filter_aspects()), (this.Feedback())]);
			return obj;
		}
		gists_title(){
		...
		Suggest_link(){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"suggest": "", "gist": null});
			(obj.sub) = () => ([(this.Suggest_icon())]);
			return obj;
		}
		gists_favorite(next){
			if(next !== undefined) return next;
		...
		Gists_favorite_duration(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.gists_favorite_duration())]);
			return obj;
		}
		gists_favorite_label(){
			return [(this.Gists_favorite_duration())];
		}
		Gists_favorite(){
			const obj = new this.$.$mol_check_icon();
			(obj.hint) = () => ("Только избранное");
			(obj.checked) = (next) => ((this.gists_favorite(next)));
			(obj.Icon) = () => ((this.Gists_favorite_icon()));
			(obj.label) = () => ((this.gists_favorite_label()));
			return obj;
		}
		gists_filter_query(next){
			if(next !== undefined) return next;
			return "";
		}
		Gists_search(){
			const obj = new this.$.$mol_search();
			(obj.query) = (next) => ((this.gists_filter_query(next)));
			return obj;
		}
		gist_links(){
			return [];
		...
		Gists(){
			...
			(obj.tools) = () => ([(this.Suggest_link()), (this.Gists_favorite())]);
			(obj.body) = () => ([(this.Gists_search()), (this.Gists_list())]);
			return obj;
		}
		Suggest(){
		...
		Filter_tag_title(id){
			const obj = new this.$.$mol_view();
			(obj.attr) = () => ({"hyoo_scout_tag_id": (this.tag_title(id))});
			(obj.sub) = () => ([(this.tag_title(id))]);
			return obj;
		}
		gist_icon(id){
			return "";
		...
		Gist_favorite(id){
			const obj = new this.$.$mol_check_icon();
			(obj.checked) = (next) => ((this.gist_favorite(id, next)));
		...
		Gist_remarks(id){
			...
			(obj.value) = (next) => ((this.gist_remarks(id, next)));
			return obj;
		}
		...
		Filter_aspect(id){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ([(this.Filter_aspect_title(id)), (this.Filter_aspect_tags(id))]);
			return obj;
		}
		Filter_tag(id){
			const obj = new this.$.$mol_check();
			(obj.checked) = (next) => ((this.filter_tag_checked(id, next)));
			(obj.label) = () => ([(this.Filter_tag_title(id))]);
			return obj;
		}
		Gist_link(id){
			const obj = new this.$.$mol_link();
			(obj.sub) = () => ([(this.Gist_link_icon(id)), (this.Gist_link_title(id))]);
			(obj.arg) = () => ({"gist": (this.key(id)), "suggest": null});
			return obj;
		}
		Gist(id){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ((this.gist_title(id)));
			(obj.tools) = () => ([(this.Gist_favorite(id)), (this.Gist_close())]);
			(obj.body) = () => ([
		...
		Gist_aspect(id){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ([(this.Gist_aspect_title(id)), (this.Gist_aspect_tags(id))]);
			return obj;
		}
		Gist_tag(id){
			const obj = new this.$.$mol_view();
	...
	($mol_mem(($.$hyoo_scout.prototype), "Theme"));
	($mol_mem(($.$hyoo_scout.prototype), "Source"));
	($mol_mem(($.$hyoo_scout.prototype), "Lights"));
	($mol_mem(($.$hyoo_scout.prototype), "Filter_aspects"));
	($mol_mem(($.$hyoo_scout.prototype), "Feedback"));
	($mol_mem(($.$hyoo_scout.prototype), "Filter"));
	($mol_mem(($.$hyoo_scout.prototype), "Suggest_icon"));
	($mol_mem(($.$hyoo_scout.prototype), "Suggest_link"));
	($mol_mem(($.$hyoo_scout.prototype), "gists_favorite"));
	($mol_mem(($.$hyoo_scout.prototype), "Gists_favorite_icon"));
	($mol_mem(($.$hyoo_scout.prototype), "Gists_favorite_duration"));
	($mol_mem(($.$hyoo_scout.prototype), "Gists_favorite"));
	($mol_mem(($.$hyoo_scout.prototype), "gists_filter_query"));
	($mol_mem(($.$hyoo_scout.prototype), "Gists_search"));
	($mol_mem(($.$hyoo_scout.prototype), "Gists_list"));
	($mol_mem(($.$hyoo_scout.prototype), "Gists"));
	($mol_mem(($.$hyoo_scout.prototype), "Suggest"));
	($mol_mem_key(($.$hyoo_scout.prototype), "Filter_aspect_title"));
	($mol_mem_key(($.$hyoo_scout.prototype), "Filter_aspect_tags"));
	($mol_mem_key(($.$hyoo_scout.prototype), "filter_tag_checked"));
	($mol_mem_key(($.$hyoo_scout.prototype), "Filter_tag_title"));
	($mol_mem_key(($.$hyoo_scout.prototype), "Gist_link_icon"));
	($mol_mem_key(($.$hyoo_scout.prototype), "Gist_link_title"));
	($mol_mem_key(($.$hyoo_scout.prototype), "gist_favorite"));
	($mol_mem(($.$hyoo_scout.prototype), "Gist_favorite_icon"));
	($mol_mem_key(($.$hyoo_scout.prototype), "Gist_favorite"));
	($mol_mem(($.$hyoo_scout.prototype), "Gist_close_icon"));
	($mol_mem(($.$hyoo_scout.prototype), "Gist_close"));
	($mol_mem_key(($.$hyoo_scout.prototype), "Gist_content"));
	($mol_mem_key(($.$hyoo_scout.prototype), "Gist_aspects"));
	($mol_mem_key(($.$hyoo_scout.prototype), "gist_remarks"));
	($mol_mem_key(($.$hyoo_scout.prototype), "Gist_remarks"));
	($mol_mem_key(($.$hyoo_scout.prototype), "Gist_aspect_title"));
	($mol_mem_key(($.$hyoo_scout.prototype), "Gist_aspect_tags"));
	($mol_mem_key(($.$hyoo_scout.prototype), "Filter_aspect"));
	($mol_mem_key(($.$hyoo_scout.prototype), "Filter_tag"));
	($mol_mem_key(($.$hyoo_scout.prototype), "Gist_link"));
	($mol_mem_key(($.$hyoo_scout.prototype), "Gist"));
	($mol_mem_key(($.$hyoo_scout.prototype), "Gist_aspect"));
	($mol_mem_key(($.$hyoo_scout.prototype), "Gist_tag"));
            ...
            gist_links() {
                ...
                if (this.gists_favorite()) {
                    ...
                    gists = gists.filter(gist => {
                        ...
                        aspect: for (const aspect of Object.keys(tags)) {
